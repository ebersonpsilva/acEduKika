                            ...
                            <div class="x_content bs-example-popovers">
                                ...
                                <div class="alert alert-danger alert-dismissible fade in" role="alert" id="Alert" style="display: none;">
                                    ...
                                    <div id="rsAlert"></div>
										...
										<form id="fornecedores" data-parsley-validate class="form-horizontal form-label-left">
											...
											<div class="form-group">
												<label for="bairro" class="control-label col-md-3 col-sm-3 col-xs-12">CNPJ</label>
											...
											<div class="form-group">
												<label class="control-label col-md-3 col-sm-3 col-xs-12"
													for="first-name">Contato <span class="required">*</span>
												</label>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="nContato" required="required" class="form-control col-md-7 col-xs-12" name="nContato" />
												</div>
											</div>
